...
<!-- PRICE -->
<!-- AKUN -->
<div style="position:absolute;top:40px;right:0px;display:inline;color:#333;text-align:right;">
<?php if($usermode == "vc"){?>
<!-- Voucher : Username = Password  -->
<div style="padding:0px;text-align:right;font-weight:bold;font-size:12px;font-family:Courier New;width:90px;background:#333;color:#fff;padding:2.5px 6px;margin-bottom:3px;">VOUCHER</div>
<div style="padding:0px 5px 0px 0px;border-top:1px solid #333;border-bottom:1px solid #333;text-align:right;font-weight:bold;font-size:20px;font-family:Courier New;"><?php echo $username;?></div>
...
<div style="padding:00px 5px 0px 0px;border-top:1px solid #fff;border-bottom:1px solid #333;text-align:right;font-weight:bold;font-size:14px;font-family:Courier New;"><small style="font-size:10px;">Us: </small><?php echo $username;?></div>
...
<!-- QRCODE-->
<?php if($qr == "yes"){?>
<div style="position:absolute;bottom:20px;left:5px;display:inline;width:60px;"><?= $qrcode ?></div>
<?php }?>
<!-- QRCODE-->
<!-- LOGO-->
<img style="position:absolute;bottom:1px;left:5px;display:inline;margin:5px 0 0 0px;width:90px;height:23px;" src="<?php echo $logo ?>" alt="logo"/>
<!-- LOGO-->
<!-- LOGIN-->
